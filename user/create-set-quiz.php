...
<head>
    ...
    <link rel="stylesheet" href="../css/edit-quiz-essay.css">
    

</head>
<body>
<form id="quizForm" action="../tools/duplicate-quiz.php" method="POST" enctype="multipart/form-data">
...
<div class="quiz-settings-column"> 
                ...
                <div class="title-box">
                                    <p class="title">Total Quiz Points: </p>
    ...
    <div class="tab-buttons">
        <button type="button" class="tab-btn active" data-tab="quiz-details"><i class="fa-solid fa-book" style="margin-right: 5px;"></i> Quiz Details</button>
        <button type="button" class="tab-btn" data-tab="date-time"><i class="fa-solid fa-calendar-days" style="margin-right: 5px;"></i> Date & Time</button>
    </div>
...
<button type="button" id="show-update-modal" class = "show-update-modal">
    <i class="fas fa-sync-alt"></i> Save as New Quiz
</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Do you want to submit this quiz for reuse?</p>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.points-essay, .minimum-per, .maximum-per').forEach(input => {
    ...
    function validateInput(input) {
        ...
        if (parseInt(value) <= 0 || isNaN(value)) {
            input.value = '';
            alert(`${input.nextElementSibling ? input.nextElementSibling.textContent : 'Value'} must be a positive number`);
            return false;
        }
    ...
    function validateAllInputs() {
        ...
        document.querySelectorAll('.typequestionhere').forEach(group => {
            ...
            // Now finally check: min must be less than max
