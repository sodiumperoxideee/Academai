...
<head>
    ...
    <title>Academai Library | Upcoming Quiz</title> 
</head>
<body>
<div class="mcq-container">
   ...
   <div class="search-container col-12">
    ...
    <div class="container card-con">
        ...
        <div class="upcoming-quizzes"></div> <!-- Cards will go here -->
       
    </div>
    

    <div class = "paginationn">
    <div class="upcoming-pagination"></div> <!-- Pagination will go here -->
    <!-- Activity Feed -->
    <div class="activity">
...
document.addEventListener("DOMContentLoaded", function () {
    const cardContainer = document.querySelector(".upcoming-quizzes");
    ...
    function initializeCards() {
        ...
        cards.forEach(card => {
            ...
            if (startDateEl) {
                cardData.startDate = startDateEl.textContent.replace('Start Date: ', '').trim();
            }
    ...
    function applyFilters() {
        ...
        if (filters.month) {
            filteredCards = filteredCards.filter(card => {
                ...
                const parts = card.startDate.trim().split(" ");
                if (parts.length === 2) {
                    const month = parseInt(parts[1], 10);
                    return !isNaN(month) && month === filters.month;
                }
                return false;
            });
        }
        ...
        if (filters.year) {
            filteredCards = filteredCards.filter(card => {
                ...
                if (parts.length === 2) {
                    ...
                    return !isNaN(year) && year === filters.year;
                }
                return false;
            });
        }
